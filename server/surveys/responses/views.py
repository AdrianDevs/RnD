...
from surveys.responses.serializers import (
    SurveyAnswerSerializerReader,
    SurveyAnswerSerializerWriter,
    SurveyResponseSerializerReader,
    SurveyResponseSerializerWriter,
)


class SurveyAnswerViewSet(ModelViewSet):
    queryset = SurveyAnswer.objects.select_related('survey_id', 'participant_id', 'question_id').prefetch_related(
        'answer_choice_ids'
    )
...
class SurveyResponseViewSet(GenericViewSet):
    queryset = SurveyResponse.objects.select_related('survey_id', 'participant_id').prefetch_related(
        'survey_answer_ids'
    )
